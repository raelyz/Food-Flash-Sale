...
INSERT INTO listing (item_name,unit_price,quantity,price_ceiling,price_floor,category_id,merchant_id,
  description,time_limit_min,live,time) VALUES('Hawaiian Pizza',10,10,8,5,1,6,'Either you hate or u love',22,true,current_timestamp);

INSERT INTO listing (item_name, unit_price,quantity,price_ceiling,price_floor,category_id,merchant_id,
  description,time_limit_min,live,time) VALUES('xiao long bao',20,10,15,10,3,5,'soupy dumplings',122,true,current_timestamp);

INSERT INTO listing (item_name, unit_price,quantity,price_ceiling,price_floor,category_id,merchant_id,
  description,time_limit_min,live,time) VALUES('Nuggets',5,10,4,2,5,1,'nuggets r life',22,true,current_timestamp);

INSERT INTO listing (item_name, unit_price,quantity,price_ceiling,price_floor,category_id,merchant_id,
  description,time_limit_min,live,time) VALUES('chicken chop',14,10,12,7,6,4,'a hearty chicken chop',222,true,current_timestamp);

INSERT INTO listing (item_name, unit_price,quantity,price_ceiling,price_floor,category_id,merchant_id,
  description,time_limit_min,live,time) VALUES('Aburi Don',20,10,15,10,6,5,'feeling torchy',22,true,current_timestamp);
